package com.example.guia1_mobil_app;
...
public class MainActivity extends AppCompatActivity {
    ...
    String HttpUrl = "https://10.0.2.2:80/Volley/User-Registration.php";
    ...
    public void UserRegistration(){
        ...
        progressDialog
                .setMessage("Please Wait, We are Inserting Your Data on Server");
                progressDialog.show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        Toast.makeText(MainActivity.this, ServerResponse,
                                Toast.LENGTH_LONG).show();
                        //showMessage("Error en repuesta delservidor",ServerResponse.toString());
                    }
                },
